...
flowchart TD
  ...
  _27 -.-> _28
  _28 -.-> _29
  click _0 "ADR-000-capability-scope-and-epistemic-honesty.md"
  click _1 "ADR-001-documentation-and-decision-hierarchy.md"
  click _2 "ADR-002-bash-runtime-and-portability-baseline.md"
  click _3 "ADR-003-make-as-canonical-orchestration-interface.md"
  click _4 "ADR-004-modular-source-and-plugin-discovery.md"
  click _5 "ADR-005-dependency-management-and-network-boundaries.md"
  click _6 "ADR-006-release-artifact-flavors-and-metadata.md"
  click _7 "ADR-007-doxygen-verbose-source-documentation.md"
  click _8 "ADR-008-documentation-driven-test-second-development.md"
  click _9 "ADR-009-observable-behavior-testing.md"
  click _10 "ADR-010-generated-reference-documentation.md"
  click _11 "ADR-011-conventional-semver-and-late-tagging.md"
  click _12 "ADR-012-standardize-sha256-checksum-companion-filenames.md"
  click _13 "ADR-013-sourceable-library-scope-and-responsibility-boundary.md"
  click _14 "ADR-014-pure-bash-runtime-and-external-command-boundary.md"
  click _15 "ADR-015-namespaced-public-api-and-caller-owned-convenience-wrappers.md"
  click _16 "ADR-016-modular-source-assembly-for-a-sourceable-library.md"
  click _17 "ADR-017-logging-pipeline-levels-formatting-and-emission.md"
  click _18 "ADR-018-redaction-as-an-opt-in-security-boundary.md"
  click _19 "ADR-019-readability-auditability-and-rejection-of-obscurity.md"
  click _20 "ADR-020-redaction-context-lifecycle-and-state-model.md"
  click _21 "ADR-021-redaction-rule-registration-ordering-and-replacement.md"
  click _22 "ADR-022-fixed-string-redaction-and-multibyte-guarantees.md"
  click _23 "ADR-023-glob-and-ere-redaction-semantics.md"
  click _24 "ADR-024-final-redaction-verification-and-fail-closed-output.md"
  click _25 "ADR-025-optional-presentation-metadata-tags-and-color.md"
  click _26 "ADR-026-adaptive-human-logfmt-rendering-and-stderr-transport.md"
  click _27 "ADR-027-configurable-severity-token-styles.md"
  click _28 "ADR-028-generate-committed-adr-navigation-with-pinned-adrctl.md"
  click _29 "ADR-029-compose-mermaid-relationship-graph-into-generated-adr-index.md"
```
